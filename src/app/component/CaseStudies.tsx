        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 p-10 mx-32 rounded-3xl bg-gray-900 ">
          {studies.map((study, index) => (
            ...
            >
              ...
              <a
                href={study.link}
                className="text-[#B9FF66] font-medium flex items-center hover:underline gap-2"
              >
                Learn more{" "}
                <span className={`h-8 w-8 flex items-center justify-center rounded-full -rotate-[30deg]`}><svg xmlns="http://www.w3.org/2000/svg" width={22} height={22}  viewBox="0 0 448 512"><path fill={'#B9FF66'} d="M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z"/></svg></span>
                  </a>
            </div>
          ))}
        </div>
